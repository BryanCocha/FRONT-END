        ...
        `<div class="card mb-3 ps-1">
            <div class="row g-0 ">
             ...
             <div class="col text-center  ">
                <div class="mt-5 mb-2">
                <button class="btn btn-actions btn-light " >edit</button>
                </div>
                <div >
             <button class="btn btn-actions btn-light delete" id="delete_${element._id}">delete</button>
                </div>
                </div>
                </div>
                </div>`
